...
export default {
  ...
  stepperpanel: {
    panel: ({ context, parent }: StepperPanelPassThroughMethodOptions) => ({
      class: [
    ...
    header: ({ parent, context }: StepperPanelPassThroughMethodOptions) => ({
      class: [
        // Position
        "relative",
        // Flexbox
    ...
    number: ({ context }: StepperPanelPassThroughMethodOptions) => ({
      class: [
        // Flexbox
        "flex",
        "items-center",
    ...
    title: ({ context }: StepperPanelPassThroughMethodOptions) => ({
      class: [
        // Layout
        "block",
        "whitespace-nowrap",
    ...
    separator: ({ context, parent }: StepperPanelPassThroughMethodOptions) => ({
      class: [
        // Colors (Conditional for active step)
        parent.state.d_activeStep <= context.index // TODO unsure about this
    ...
    content: ({ parent }: StepperPanelPassThroughMethodOptions) => ({
...
} satisfies StepperPassThroughOptions;
