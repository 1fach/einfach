defmodule EinfachApiWeb.Auth.Guardian do
  use Guardian, otp_app: :einfach_api
  ...
  @spec resource_from_claims(any()) :: {:error, :no_id_provided | :not_found} | {:ok, any()}
  ...
  defp token_options(type) do
    case type do
      ...
      #:admin -> [token_type: "admin", ttl: {7, :day}]
    end
  end
